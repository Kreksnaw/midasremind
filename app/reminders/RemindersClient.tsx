    ...
    <div className="p-4 sm:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5 sm:mb-6">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-[#0f2744] text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-[#1a3a60] transition-colors shadow-sm w-full sm:w-auto disabled:opacity-60"
        >
          <Bell size={15} />
          Send All Pending
        </button>
